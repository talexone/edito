...
import com.tialys.edito.repository.ThemeRepository;
...
public class ThemeResourceIT {
    ...
    public void createTheme() throws Exception {
        ...
        assertThat(testTheme.getCreateDate()).isEqualTo(DEFAULT_CREATE_DATE);
        assertThat(testTheme.getPublishDate()).isEqualTo(DEFAULT_PUBLISH_DATE);
    ...
    public void updateTheme() throws Exception {
        ...
        Theme testTheme = themeList.get(themeList.size() - 1);
        assertThat(testTheme.getCreateDate()).isEqualTo(UPDATED_CREATE_DATE);
        assertThat(testTheme.getPublishDate()).isEqualTo(UPDATED_PUBLISH_DATE);
