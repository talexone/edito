...
export class ThemeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.themeService
      ...
      .subscribe(
        (res: HttpResponse<ITheme[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ITheme[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
